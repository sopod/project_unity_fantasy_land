...
public class MachineController : MovingThings
{
    ...
    public void SetMachine(Options options)
    {
        ...
        ChangeMachineValue(options.machineSwingSpeed, options.machineSwingAngleMax, options.machineSpinSpeed);
        ChangeSpinDirection(options.isSpiningCW);
        HoldMachine(options.isMachineSwinging, options.isMachineTurning, options.isMachineSpining);
